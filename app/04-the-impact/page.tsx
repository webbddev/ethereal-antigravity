...
const galleryImages = [
  {
    ...
    alt: 'Analytics dashboard showing positive user engagement',
  },
  {
    src: 'https://images.unsplash.com/photo-1516321497487-e288fb19713f?w=800&h=600&fit=crop&q=80',
    alt: 'A team celebrating the successful launch of the project',
  },
  {
    src: 'https://images.unsplash.com/photo-1544725176-7c40e5a71c5e?w=800&h=600&fit=crop&q=80',
    alt: 'Mockup of the final product on various devices',
  },
];

export default function TheImpactPage() {
  return (
      ...
      <section className='py-40'>
        <div className='container mx-auto px-6'>
          ...
          <p className='text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl mb-24'>
            This page discusses the significance and impact of the immersive
            scroll experience. It covers how it enhances user engagement, its
            real-world applications, and future possibilities, demonstrating the
